  ...
  return (
    <>
      ...
      >
        ...
        {totalVentas > 0 && (
          <div className="mt-4 flex items-center justify-center gap-2 rounded-full bg-white/10 px-6 py-2 text-sm font-semibold text-green-400 backdrop-blur-sm border border-white/20">
            <span className="text-xl">🏆</span>
            <span>+{totalVentas} vehículos vendidos</span>
          </div>
        )}
